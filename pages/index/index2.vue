...
<script>
import Emotion from '../../component/Emotion/index.vue'
export default {
  data () {
    return {
	  showHtml : "",
  ...
  methods: {
	...
	send(){
		this.showHtml = this.content.replace(/\#[\u4E00-\u9FA5]{1,3}\;/gi,this.my);
		console.log("this.showHtml: " + JSON.stringify(this.showHtml));
	},
	my(res){
